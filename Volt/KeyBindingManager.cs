...
public class KeyBindingManager
{
    public static readonly Dictionary<VoltCommand, KeyCombo> Defaults = new()
    {
        ...
        [VoltCommand.ReopenClosedTab] = new(Key.T, ModifierKeys.Control | ModifierKeys.Shift),
        ...
        [VoltCommand.ToggleIssues] = KeyCombo.None,
    ...
    public static string GetDisplayName(VoltCommand command) => command switch
    {
        ...
        VoltCommand.ReopenClosedTab => "Reopen Closed Tab",
        ...
        VoltCommand.ToggleIssues => "Toggle Issues",
