...
public class ThemeManager
{
    ...
    private void UpdateAppResources()
    {
        ...
        [
            ...
            (ThemeResourceKeys.DiagnosticErrorFg, c.DiagnosticErrorForeground),
            (ThemeResourceKeys.DiagnosticErrorBg, c.DiagnosticErrorBackground),
            (ThemeResourceKeys.DiagnosticWarningFg, c.DiagnosticWarningForeground),
            (ThemeResourceKeys.DiagnosticInfoFg, c.DiagnosticInfoForeground),
